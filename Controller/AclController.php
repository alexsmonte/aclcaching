<?php
App::uses('AclCachingAppController', 'AclCaching.Controller');
 ...
 *
 */
class AclController extends AclCachingAppController {

	public $components = array('Acl', 'AclCaching.AclCaching');
	...
	*/
	function index()
	{
		...
		$this->set('title_for_layout', 'Permissão de grupo');
		// Carrega Model
