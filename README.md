...
Faça o download do plugin e coloque seu conteúdo dentro de `/App/Plugins/AclCaching` ou em outro diretório para plugins do CakePHP.
...
var $components = array(
    'Auth' => array('authorize'	=> array('AclCaching.AclCaching' => array('actionPath' => 'controllers', 'userModel'  => 'Usuario'))),
    'Session',       
    'RequestHandler',
	'AclCaching.AclCaching' => array('use' => array('contain' => false), 
													 'aro' => array('model' => 'Grupo', 'primaryKey' => 'id','displayField' => 'nome','foreignKey' => 'grupo_id')),
);
...
Copyright 2015, Alex Monte (http://leleco.blog.br )
