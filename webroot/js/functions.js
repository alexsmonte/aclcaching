...
function acl_toggle_right(start_granted, app_root_url, span_id, role_id, plugin, controller, action)
{
    ...
    if(start_granted)
    {
        var url1 = app_root_url + "acl_caching/acl/deny/" + role_id + "/plugin:" + plugin + "/controller:" + controller + "/action:" + action;
        var url2 = app_root_url + "acl_caching/acl/allow/" + role_id + "/plugin:" + plugin + "/controller:" + controller + "/action:" + action;
    }
    else
    {
        var url1 = app_root_url + "acl_caching/acl/allow/" + role_id + "/plugin:" + plugin + "/controller:" + controller + "/action:" + action;
        var url2 = app_root_url + "acl_caching/acl/deny/" + role_id + "/plugin:" + plugin + "/controller:" + controller + "/action:" + action;
    }
